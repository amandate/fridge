...
NEW_FOOD_STORAGE_REQUEST_MESSAGE = "This food storage type does not exist. Would you like to create one? (y/n): "
NO_LOADED_PROFILE_MESSAGE = "Please create or load a profile before proceeding."
OPEN_FOOD_STORAGE_ACTION = "Opening food storage."
OPEN_FOOD_STORAGE_MESSAGE = "You would like to open a food storage. Here are the food storages available: {}"
OPEN_FOOD_STORAGE_NAME = "Which food storage type would you like to open?: "
